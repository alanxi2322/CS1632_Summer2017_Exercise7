...
public class Monkey {
    ...
    // REFACTORED VERSION OF NEXTMONKEYANDRESIZEREFACTORED
    // REMOVED MATH FUNCTIONS AND LOOPS AND JUST ADDED RESULT
    // OF PREVIOUS CALCULATIONS TO KEEP ID RESTULTS CONSISTENT

    public int generateIdRefactored(int n) {
      int toReturn = 100;
      if (n > 0) {
        return toReturn += (223392 + n);
      }
      return 0;
    }
	...
	_monkeyNum++;
	// _id = generateId(_thisMonkeyNum); // ORIGINAL METHOD
  _id = generateIdRefactored(_thisMonkeyNum); // REFACTORED METHOD

    }


  public String toString() {
    return "Monkey: " + _thisMonkeyNum;
  }
